...
import featuredSectionImg from '../../assets/Featured-Section.png';
import propertiesSectionImg from '../../assets/Properties-section.png';
import topImg from '../../assets/Top.png';
import propertiesImg from '../../assets/Properties(1).png';
import financesImg from '../../assets/Finances.png';
		  ...
		  <div className='relative mt-40'>
			<div className='flex justify-between flex-col lg:flex-row space-y-7'>
			  <div className='mt-24 lg:mt-44'>
				...
				<p className='mt-3 font-normal text-base lg:text-xl text-[#242828]'>
				  ...
				  your company’s logo and color scheme, ensuring a cohesive and <br />
				  branded experience. With integrated features like payment, <br />
			  ...
			  <div className='bg-[#F5F6F6] border rounded-2xl shadow-2xl items-center justify-center flex p-7 flex-col space-y-3 w-[440px] lg:w-[480px]'>
				<img src={landingPageImg} className='border' alt='Landing Page' />
				<img src={featuredSectionImg} className='border' alt='Featured Section' />
			  </div>
			</div>
			<div className='flex justify-between flex-col lg:flex-row space-y-7 mt-20'>
			  <div className='bg-[#F5F6F6] border rounded-2xl shadow-2xl items-center justify-center flex p-7 flex-col space-y-3 w-[400px] lg:w-[480px]'>
				<img src={propertiesSectionImg} className='border' alt='Properties Section' />
				<img src={topImg} className='border' alt='Top Section' />
			  </div>
			  <div className='mt-40'>
				...
				<h1 className='font-bold text-2xl lg:text-3xl'>Easy-to-Use Interface</h1>
				<p className='mt-3 font-normal text-base lg:text-xl text-[#242828]'>
				  Our platform is intuitively designed, enabling real estate <br />
				  companies to effortlessly create, manage, and handle <br />
				  properties listing and transactions. No technical expertise is <br />
				  required—just a few clicks, and you are on your way to <br />
				  driving success.
				</p>
			  </div>
			</div>
			<div className='flex justify-between flex-col lg:flex-row space-y-7 mt-16'>
			  ...
			  <div className='bg-[#F5F6F6] border rounded-2xl shadow-2xl items-center justify-center flex p-7 flex-col space-y-3 w-[400px] lg:w-[480px]'>
				<img src={propertiesImg} className='border' alt='Properties Image' />
				<img src={financesImg} className='border' alt='Finances Image' />
			  </div>
			</div>
		  </div>
		</div>
